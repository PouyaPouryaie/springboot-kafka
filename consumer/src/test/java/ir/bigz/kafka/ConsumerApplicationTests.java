...
//    }
    ...
    @BeforeEach
    public void setup() {
        kafkaMessageListener.resetLatch();
    }
    ...
    public void testConsumeEvent() throws Exception{
        ...
        Awaitility.await().pollInterval(Duration.ofSeconds(3))
                ...
                .untilAsserted(() -> {
                    long messageConsumed = kafkaMessageListener.getLatch().getCount();
    ...
    public void testConsumeMessage() throws Exception{
        ...
        boolean messageConsumed = kafkaMessageListener.getLatch().await(10, TimeUnit.SECONDS);
